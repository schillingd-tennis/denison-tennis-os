/**
 * UTR profile page content script.
 * Fetches structured results using the page's authenticated session.
 * Returns tennis JSON only — never reads or forwards JWT/cookies/localStorage.
 */
(function () {
