...
export function buildRecruitingFilterDefinitions(
  ...
  return [
    ...
    ...lookupFilters(RECRUIT_PRIORITY_SEED, "priority", (row) => row.profile.priority?.key),
    {
      ...
      label: "Tier 1",
      category: "tier",
      predicate: (row) => row.profile.tier === 1,
    },
    {
      id: "tier:2",
      label: "Tier 2",
      category: "tier",
      predicate: (row) => row.profile.tier === 2,
    },
    {
      id: "tier:3",
      label: "Tier 3",
      category: "tier",
      predicate: (row) => row.profile.tier === 3,
    },
    {
      id: "tier:4",
      label: "Tier 4",
      category: "tier",
      predicate: (row) => row.profile.tier === 4,
    },
    {
      id: "tier:5",
      label: "Tier 5",
      category: "tier",
      predicate: (row) => row.profile.tier === 5,
    },
    {
      id: "tier:none",
      label: "Unassigned",
      category: "tier",
      predicate: (row) => row.profile.tier == null,
    },
