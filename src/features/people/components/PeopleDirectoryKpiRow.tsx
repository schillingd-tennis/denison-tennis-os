...
/**
 * Same summary-card visual system as Recruiting Rank (`RecruitingKpiRow`).
 * Counts are existing roster facts — not new analytics.
 */
        ...
        return (
          ...
          >
            <div className="min-w-0">
              <p
                className={`text-[28px] leading-none font-semibold tabular-nums tracking-tight ${valueClass[card.tone]}`}
              >
                {value}
              </p>
