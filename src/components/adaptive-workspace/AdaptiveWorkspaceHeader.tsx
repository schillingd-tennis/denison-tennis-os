 ...
 *
 * Desktop (md+): original `px-5` padding and non-truncated title.
 * Mobile (< md): slightly tighter padding; title may truncate.
 */
export default function AdaptiveWorkspaceHeader({
  ...
  return (
    <header className="flex shrink-0 items-start justify-between gap-3 border-b border-[var(--module-border)] px-5 py-2 max-md:min-w-0 max-md:px-4">
      <div className="min-w-0">
        <h3 className="text-base font-semibold tracking-tight text-text-primary max-md:truncate">
          {title}
        </h3>
        {subtitle ? (
