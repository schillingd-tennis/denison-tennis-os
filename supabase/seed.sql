...
--
-- Generated: 2026-08-05T20:53:48.112Z
-- Records: 40
--
...
on conflict (id) do update set
  role_id = coalesce(public.production_people.role_id, excluded.role_id),
    ...
    personal_email = coalesce(public.production_people.personal_email, excluded.personal_email),
    denison_email = coalesce(public.production_people.denison_email, excluded.denison_email),
    city = coalesce(public.production_people.city, excluded.city),
    state = coalesce(public.production_people.state, excluded.state),
    country = coalesce(public.production_people.country, excluded.country),
    class_year = coalesce(public.production_people.class_year, excluded.class_year),
    major = coalesce(public.production_people.major, excluded.major),
    minor = coalesce(public.production_people.minor, excluded.minor),
    denison_id = coalesce(public.production_people.denison_id, excluded.denison_id),
    utr = coalesce(public.production_people.utr, excluded.utr),
    wtn = coalesce(public.production_people.wtn, excluded.wtn),
    notes = coalesce(public.production_people.notes, excluded.notes),
    dominant_hand = coalesce(public.production_people.dominant_hand, excluded.dominant_hand),
    ...
    preferred_contact_method = coalesce(public.production_people.preferred_contact_method, excluded.preferred_contact_method),
    address_line1 = coalesce(public.production_people.address_line1, excluded.address_line1),
    address_line2 = coalesce(public.production_people.address_line2, excluded.address_line2),
    zip_code = coalesce(public.production_people.zip_code, excluded.zip_code),
    dorm = coalesce(public.production_people.dorm, excluded.dorm),
    room_number = coalesce(public.production_people.room_number, excluded.room_number),
